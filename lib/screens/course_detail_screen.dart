                                ...
                                onTap: () {
                                  if (loadedCourse.courseOverviewProvider ==
                                    ...
                                    if (loadedCourse
                                     ...
                                     var videoId = YoutubePlayer.convertUrlToId(loadedCourse.courseOverviewUrl!);
                            ...
                            MaterialButton(
                                  ...
                                  if (_authToken != null) {
                                    if (loadedCourse.isFreeCourse == '1') {
                                      try {
                                        ...
                                        if (mounted) {
                                          setState(() {
                                            // Agar mutable model hai:
                                            loadedCourseDetail.isPurchased = true;

                                            // Agar immutable model hai, to is tarah (agar copyWith available ho):
                                            // loadedCourseDetail = loadedCourseDetail.copyWith(isPurchased: true);
                                          });
                                        }
                              ...
                              child: Text(
                                loadedCourseDetail.isPurchased!
                                    ? 'Purchased'
                                    : (loadedCourse.isFreeCourse == '1' ? 'Get Enroll' : 'Buy Now'),
                                            ...
                                            itemBuilder: (ctx, index) {
                                              return Column(
                                                children: [
                                                  LessonListItem(
                                                    lesson:
                                                        section.mLesson![index],
                                                    courseId: loadedCourseDetail
                                                        .courseId!,
                                                  ),
                                                  if (index <

...
class MyBundleCoursesListScreen extends StatefulWidget {
  ...
  const MyBundleCoursesListScreen({super.key});
                        ...
                        children: [
                          ...
                          MaterialButton(
                            ...
                            onPressed: () async {
                              ...
                              final redirect_url = "https://learn.greylearn.com/go/smart-open/my_course";

                              final url =
                                  '$BASE_URL/api/web_redirect_to_buy_bundle/$authToken/$bundleId/$redirect_url';
                              _launchURL(url);
                            },
